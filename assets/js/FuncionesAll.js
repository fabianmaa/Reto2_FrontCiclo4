...
function traerInformacionProductos(){
    console.log("test");
        $.ajax({
        url:"http://129.151.120.50:8096/api/chocolate/all",
        type:"GET",
        datatype:"JSON",
        ...
        success: function (response) {
            ...
            if (response == true) {
                ...
                $.ajax({
                    ...
                    url: "http://129.151.120.50:8096/api/chocolate/new",
                    success: function (response) {
                        console.log(response);
...
function traerInformacionUsuarios(){
    console.log("test");
        $.ajax({
        url:"http://129.151.120.50:8096/api/user/all",
        type:"GET",
        datatype:"JSON",
        success:function(respuesta){
            console.log(respuesta);
...
function borrarUsuario(id){
    ...
    console.log(dataToSend);
    $.ajax({
        url:"http://129.151.120.50:8096/api/user/"+id,
        type:"DELETE",
        data:dataToSend,
        contentType:"application/JSON",
        datatype:"JSON",
...
if (formValues) {
  Swal.fire(JSON.stringify(formValues))
    ...
    $.ajax({
        dataType: 'json',
        url:"http://129.151.120.50:8096/api/user/update",
